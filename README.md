...
Includes independent multi-parameter search function, login with normal and admin-level user types, pages for most-searched and highest-rated titles, and user opt-in for newsletters using real email.
